...
If you want to report a problem or suggestion with Image Uppload Widget, please open an issue in the main [elninotech/uppload](https://github.com/elninotech/uppload) repo and add the label "examples".
